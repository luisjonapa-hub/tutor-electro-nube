...
if not st.session_state.authenticated:
    ...
    if login_btn:
        try:
            ...
            creds_df = conn.read(worksheet="Credenciales_H", ttl=0)
...
PASO 11: Felicitar al equipo y comunicarle que han concluido la práctica, decirles que ya pueden cerrar el navegador y que su bitácora ha sido registrada en la pestaña 'Bitacora' de Google Sheets.
